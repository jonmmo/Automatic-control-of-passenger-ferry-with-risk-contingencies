function plot_results_sim4(x, x1, x2, x3, WP, eta_dock, p_o)
% plot results
...
plot(x(5, 2), x(4, 2), 'Bo')
plot(x1(5, 480), x1(4, 480), 'Bo')
plot(x2(5, 520), x2(4, 520), 'Bo')
plot(x3(5, 540), x3(4, 540), 'Bo')
legend('Vessel position run 1','Desired position run 1','', ...
    ...
    'Transit waypoints', 'Dock', 'Initial position', ...
